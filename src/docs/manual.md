...
- 说明：根据 ID 获取 _舞萌 DX_ 乐曲封面及标题用于手元投稿等
- 指令：`@提比不想睡觉` `/maijacket` `<乐曲ID>`
- 用法示例：`@提比不想睡觉` `/maijacket 11661`
...
- 说明：更新水鱼/落雪查分器成绩
- 可用场景： <Badge type="tip" text="QQ私聊" /> <Badge type="tip" text="频道私信" />
- 指令：`/上传成绩`

> [!DANGER] 重要声明
>
> - 该方法需要通过二维码登录您的舞萌DX账号
> - 提比不推荐您使用该方法上传成绩
> - 提比推荐在落雪查分器网站上传成绩
...
- 可用场景：<Badge type="tip" text="QQ群" /> <Badge type="tip" text="QQ私聊" /> <Badge type="tip" text="QQ频道" /> <Badge type="tip" text="频道私信" />
- 指令：`@提比不想睡觉` `/中二进度表 [条件]`
- 用法示例：`@提比不想睡觉` `/中二进度表 14+`
- 用法示例：`@提比不想睡觉` `/中二进度表 sun plus`

::: details 点击显示详情
不带任何参数地输入 `/中二进度表` 可以查看所有支持的条件
:::
